...
const BuyHouse = ({ singleBuyHouse }) => {
    const { area, description, estate_title, facilities, image, location, price, segment_name, } = singleBuyHouse;

    return (
        <div data-aos="zoom-in" data-aos-duration="1000" className='bg-[#f5f6f7] mt-5 pt-4 rounded-xl'>
...
BuyHouse.propTypes = {
    singleBuyHouse: PropTypes.object
}
